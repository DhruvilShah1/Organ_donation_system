...
<body>
    <div class="container">
        ...
        <form method="post">
            ...
            <input type="password" placeholder="Password" name="d_password" required>
            <button type="submit" class="register-button" name="submit">Login</button>
        </form>
        <p>Already Not have an account? <a href="donor_register.php">Register Here</a></p>
    </div>
</body>
</html>
...
if (isset($_POST["submit"])) {
    ...
    $query = "SELECT * FROM `donor_login` WHERE d_email = '$email' AND d_password = '$password'";
        ...
        if (mysqli_num_rows($result) == 1) {
            ...
            echo "<script>
                Swal.fire({
                    ...
                    window.location.href = 'sidebar.php?donor'; // Redirect on click
                });
            </script>";
        } else {
